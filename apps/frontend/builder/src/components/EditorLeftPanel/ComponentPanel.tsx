import { ScrollArea } from '@lowcode/shadcn/components/ui/scroll-area'
    ...
    components: [
      {
        ...
        icon: (
          ...
          >
            <path
              d="M21 4H18V2H21C22.6569 2 24 3.34315 24 5V8H22V5C22 4.44772 21.5523 4 21 4Z"
              fill="var(--fg-color)"
            />
            <path
              d="M2 8V5C2 4.44772 2.44771 4 3 4H6V2H3C1.34315 2 0 3.34315 0 5V8H2Z"
              fill="var(--fg-color)"
            />
            <path
              d="M0 16V19C0 20.6569 1.34315 22 3 22H6V20H3C2.44772 20 2 19.5523 2 19V16H0Z"
              fill="var(--fg-color)"
            />
            <path
...
export function ComponentPanel() {
  useEffect(() => {
    ...
    //     // 阈值问题
    //     // 连续点击问题
    //     item.addEventListener('mousedown', (ev: MouseEvent) => {
    //         dragging = true
